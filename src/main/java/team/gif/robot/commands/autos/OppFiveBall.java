...
public class OppFiveBall extends SequentialCommandGroup {
    ...
    public Command reverse() {
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            List.of(
                ...
                new Pose2dFeet(     0.0, 0, 0).get(),  // zerod
                new Pose2dFeet(-92/12.0, 0, 0).get()   // move backward to pickup power cells
            ),
    ...
    public Command forward(){
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            List.of(
                new Pose2dFeet(-92/12.0,   0.0,  0).get(),
                new Pose2dFeet(    -2.0, -14.0, -7).get()
            ),
