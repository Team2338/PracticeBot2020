...
public class Bounce extends SequentialCommandGroup {
    ...
    public Command leg2() {
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
                List.of(
                        ...
                        new Pose2dFeet().set(13.0 - xInit, 3.0 - yInit, 180.0), // ~E5
                        new Pose2dFeet().set(14.5 - xInit, 3.0 - yInit, 180.0),
                        new Pose2dFeet().set(14.5 - xInit, 6.0 - yInit, 90.0), // D6
                        new Pose2dFeet().set(14.5 - xInit, 12.5 - yInit, 90.0) // A6 *
                ),
    ...
    /*public Command leg3() {
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
                List.of(
                        new Pose2dFeet().set(15.0 - xInit, 11.5 - yInit, 90.0), // A6 *
                        new Pose2dFeet().set(17.5 - xInit, 2.5 - yInit, 0.0), // E7
                        new Pose2dFeet().set(20.0 - xInit, 2.5 - yInit, 0.0), // E8
                        new Pose2dFeet().set(22.5 - xInit, 11.5 - yInit, -90.0) // A9 *
                ),
