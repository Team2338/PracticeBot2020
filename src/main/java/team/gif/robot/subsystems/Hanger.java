...
//    public static Hanger instance = null;
    ...
    private static final SparkMaxLimitSwitch limitSwitch = hangMotor.getReverseLimitSwitch(SparkMaxLimitSwitch.Type.kNormallyClosed);

    private static final Solenoid hangerRatchet = new Solenoid(CTREPCM, RobotMap.SOLENOID_HANGER);
    ...
    public void setPoint(int position) {
        hangPIDController.setReference(position, CANSparkMax.ControlType.kVelocity);
    }
