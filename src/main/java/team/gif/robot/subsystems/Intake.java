...
//    private static final TalonSRX intakeMotor = new TalonSRX(RobotMap.INTAKE);
    ...
    private static final Solenoid solenoidZero = new Solenoid(CTREPCM, RobotMap.SOLENOID_ZERO);
    private static final Solenoid solenoidOne = new Solenoid(CTREPCM, RobotMap.SOLENOID_ONE);
    private static final Solenoid solenoidTwo = new Solenoid(CTREPCM, RobotMap.SOLENOID_TWO);
