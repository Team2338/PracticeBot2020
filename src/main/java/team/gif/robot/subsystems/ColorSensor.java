...
//  private final Color kYellowTarget = ColorMatch.makeColor(0.320, 0.550, 0.130);
   ...
   * Under Table
   */
  private final Color kBlueTarget = new Color(0.198, 0.457, 0.345);
  private final Color kGreenTarget = new Color(0.224, 0.510, 0.266);
  private final Color kRedTarget = new Color(0.330, 0.442, 0.228);
  private final Color kYellowTarget = new Color(0.286, 0.518, 0.195);
